        ...
        handler: (request, response) => __awaiter(void 0, void 0, void 0, function* () {
            ...
            try {
                ...
                data["category"].length !== 0
                    ...
                    : null;
                data["title"].length !== 0 ? (filter["title"] = data["title"]) : null;
                ((_a = data["budget_type"]) === null || _a === void 0 ? void 0 : _a["hourly"]) ? (filter["hourly"] = true) : null;
                if (((_b = data["budget_type"]) === null || _b === void 0 ? void 0 : _b["hourly"].length) !== 0) {
                    filter["hourly_min_value"] =
                        data["budget_type"]["hourly"][0].min_value;
                    filter["hourly_max_value"] =
                        data["budget_type"]["hourly"][0].max_value;
                }
                console.log('filter["hourly_max_value"] ------------------------>>>>>>>>>>>>', filter["hourly_max_value"]);
                ...
                const findedjobs = yield job_3.default.aggregate([
                    ...
                    {
                        $match: { budget_type: 1, budget_amount: { '$lt': 200 } },
                    },
                    {
