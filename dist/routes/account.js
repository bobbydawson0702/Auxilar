...
exports.accountRoute = [
    ...
    },
    {
        ...
        handler: (request, response) => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const token = jsonwebtoken_1.default.sign({ passcode: passcode }, config_1.default.jwtSecret, {
                expiresIn: "1day",
            });
    ...
    },
    {
        ...
        handler: (request, response) => __awaiter(void 0, void 0, void 0, function* () {
            try {
                ...
                const decodedtoken = jsonwebtoken_1.default.decode(request.params.token);
                const passcode = yield passcode_1.default.findOne({
